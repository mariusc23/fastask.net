...
<span id="constants" style="display: none">
  <div id="data-help">
    <div id="h-top" class="help">
      ...
      <div class="text">
        ...
        <h2 id="h-mini">Mini box</h2>
        <a href="#h-top">back to top</a><p>

        <h3>Mini top bar</h3>
        <p>
          This mini top bar has 2 tabs: planner and trash.
          <ul>
    ...
    <div id="mini" class="mini-box box" rel="1">
      ...
      <div class="tabs">
        <div class="icon planner" title="stuff witout a due date">
          <a href="#l=1"></a><span class="c"></span>
        </div>
        <div class="icon trash" title="bleh, garbage">
          <a href="#l=2"></a><span class="c"></span>
        </div>
      </div>
      <div class="table" cellspacing="0"></div>
    </div>
  </div>
</span>

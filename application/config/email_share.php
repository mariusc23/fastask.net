<?php
/**
 * Setup of invitation email for new collaborators.
 */
...
If you accept their request, you will be able to assign tasks to them, ' .
'and they will be able to assign tasks to you. The assignments (2nd tab) ' .
'and command center (3rd tab) will keep tasks created by them or assigned ' .
'to them separate from your own.
...
$additional_headers = "From: " . SITE_NAME .
    " Team <fastask@craciunoiu.net>\r\n" .
    "Reply-To: " . SITE_NAME . " Team <fastask@craciunoiu.net>\r\n";

Kohana::$log->add('user_share', 'Request to share from ' .
    "{$this->user->username} ({$this->user->id}), sent to: {$user->username} ({$user->email})");

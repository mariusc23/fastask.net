...
/**
 * Pagination links generator. Modified from default Kohana pagination.
 */
class Pagination {
	...
	public function url($page = 1)
	{
		...
		{
			case 'query_string':
                if ($this->config['current_page']['output'] == 'hash') {
                    return URL::query(array($this->config['current_page']['key'] => null)) . '#' . $this->config['current_page']['key'] . '=' . $page;
                }
